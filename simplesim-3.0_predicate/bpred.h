...
struct bpred_update_t {
  ...
  /* add new char *predicate; ---- Nang Le*/
  struct {		/* predicted directions */
	...
	/* assign new value unsigned int predicate : 1; ---- Nang Le */
  } dir;
};
...
bpred_create(enum bpred_class class,	/* type of predictor to create */
		 ...
		 /* should add new table size for predicate predictor in this function -- Nang */
